            ...
            <div className="row d-flex justify-content-start rtl pt-4">
              ...
              <div className="col-12 mt-3">
                <p className="content_text">
                  قارون بازاری برای عرضه و تقاضای آنلاین طیف گسترده ای از محصولات باتنوع چشمگیر، همراه با طرحهای ویژه تجاریست که کاربرانش را در سود معاملات خود سهیم مینماید. بازار آنلاین اجتماعی قارون
                  با هدف ایجاد یک بستر گسترده تجاری برای عموم کاربران جامعه و بازاری وسیع، متنوع و رقابتی باتوجه به شرایط بومی هر موقعیت می باشد که دارای ویژگیهای منحصر بفردی جهت کاربری هرچه ساده تر و
                  بهتر برای استفاده کنندگان خود است. دراین راستا ایجاد فضایی جذاب و پویا درعین حال ساده و امن برای کاربران از اهمیت خاصی برخوردار است.
                </p>
